...
//##### COMMON INFO ####
#define NB_SENSORS 6
int read_sensors[NB_SENSORS], old_read[NB_SENSORS];
#define SENSOR_FL 0
#define SENSOR_FR 1
#define SENSOR_L 2
#define SENSOR_R 3
...
void setupSensors()
{
  ...
  sensor_fl.setMeasurementTimingBudget(50000);
 //sensor_fl.startContinuous();
  ...
  sensor_fr.setMeasurementTimingBudget(100000);
